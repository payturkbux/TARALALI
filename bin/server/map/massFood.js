...
exports.MassFood = class {
  constructor(playerFiring, cellIndex, mass) {
    ...
    this.direction = new sat.Vector(playerFiring.x - playerFiring.cells[cellIndex].x + playerFiring.target.x, playerFiring.y - playerFiring.cells[cellIndex].y + playerFiring.target.y).normalize();
